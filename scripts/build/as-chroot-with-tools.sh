...
sh /tools/6.54-make-coreutils.sh
sh /tools/6.55-make-check.sh 
sh /tools/6.56-make-diffutils.sh 
sh /tools/6.57-make-gawk.sh 
sh /tools/6.58-make-findutils.sh 
sh /tools/6.59-make-groff.sh
sh /tools/6.60-make-grub.sh 
sh /tools/6.61-make-less.sh 
sh /tools/6.62-make-gzip.sh 
sh /tools/6.63-make-iproute2.sh
sh /tools/6.64-make-kbd.sh 
sh /tools/6.65-make-libpipeline.sh 
sh /tools/6.66-make-make.sh 
sh /tools/6.67-make-patch.sh
sh /tools/6.68-make-man-db.sh 
sh /tools/6.69-make-tar.sh 
sh /tools/6.70-make-texinfo.sh 
sh /tools/6.71-make-vim.sh
sh /tools/6.72-make-systemd.sh
sh /tools/6.73-make-dbus.sh
sh /tools/6.74-make-procps-ng.sh
sh /tools/6.75-make-util-linux.sh
sh /tools/6.76-make-e2fsprogs.sh
sh /tools/6.78-strip.sh
sh /tools/6.79-clean.sh
