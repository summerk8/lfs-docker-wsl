...
LABEL version="8.4"
LABEL maintainer="samir.kerimof@gmail.com"
...
# run following code on Debian 9 ONLY
...
RUN mkdir -pv $LFS/tools && ln    -sv $LFS/tools /
...
RUN chown -v lfs $LFS/tools  && chown -v lfs $LFS/sources
